<template>
  <div class="flex items-center justify-between px-4 py-3 bg-white border-t border-gray-200 sm:px-6">
    <div class="flex justify-between flex-1 sm:hidden">
      ...
      <button class="relative inline-flex items-center px-4 py-2 text-sm border rounded-md w-[28%] justify-center" @click="togglePaginateMenu" v-click-outside="closePaginationMenu">
